...
def cmplts_score(gt_labels, pred_labels):
    return completeness_score(pred_labels, gt_labels)

def homg_score(gt_labels, pred_labels):
    return homogeneity_score(pred_labels, gt_labels)

def v_mesure(gt_labels, pred_labels):
    return v_measure_score(pred_labels, gt_labels)
